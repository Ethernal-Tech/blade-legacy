...
// 	headersMap := &helpers.TestHeadersMap{HeadersByNumber: make(map[uint64]*types.Header)}
...
// 	blockchainMock := new(helpers.BlockchainMock)
...
// 	allValidators := validator.NewTestValidators(t, totalValidators).GetPublicIdentities()
// 	headersMap := &helpers.TestHeadersMap{}
