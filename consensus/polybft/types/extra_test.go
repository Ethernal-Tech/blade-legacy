...
// 	keys := polytesting.CreateRandomTestKeys(t, 2)
...
// 		parentSignature := createSignature(t, []*wallet.Account{key}, types.BytesToHash(polytesting.GenerateRandomBytes(t)), signer.DomainBridge)
// 		extraMarshalled.Set(parentSignature.MarshalRLPWith(ar))

// 		// Committed
// 		committedSignature := createSignature(t, []*wallet.Account{key}, types.BytesToHash(polytesting.GenerateRandomBytes(t)), signer.DomainBridge)
// 		extraMarshalled.Set(committedSignature.MarshalRLPWith(ar))

// 		// Block meta data
// 		BlockMetaArr := ar.NewArray()
// 		BlockMetaArr.Set(ar.NewBytes(polytesting.GenerateRandomBytes(t)))
...
// 	header := &types.Header{
// 		Number: headerNum,
// 		Hash:   types.BytesToHash(polytesting.GenerateRandomBytes(t)),
// 	}
// 	parent := &types.Header{
// 		Number: headerNum - 1,
// 		Hash:   types.BytesToHash(polytesting.GenerateRandomBytes(t)),
...
// 	polyBackendMock := new(polytesting.PolybftBackendMock)
...
// 	blockHash := types.BytesToHash(polytesting.GenerateRandomBytes(t))
